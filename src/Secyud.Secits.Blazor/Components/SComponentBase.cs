...
public class SComponentBase : IComponent, IHandleEvent, IHandleAfterRender
{
    ...
    protected virtual void OnBuildRenderTree(RenderTreeBuilder builder)
    {
