    ...
    IEquatable<SValue>,IMaybeClassParameter
{
    ...
    public static SValue Inherit => GlobalParameter.Inherit;
    public static SValue Initial => GlobalParameter.Initial;
    public static SValue Unset => GlobalParameter.Unset;
